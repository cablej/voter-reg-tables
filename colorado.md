...
| Category         | Entity                                     | Name | Home address | Mailing address | Year of birth | Full Date of birth | Tel num | Email address | Driver's license / ID card number | Full SSN | SSN last 4 digits | Political Party affiliation | Date of affiliation | Gender identity | Signature | Voting activity history |
| ---------------- | ------------------------------------------ | ---- | ------------ | --------------- | ------------- | ------------------ | ------- | ------------- | --------------------------------- | -------- | ----------------- | --------------------------- | ------------------- | --------------- | --------- | ----------------------- |
...
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- |
| Incomplete registration | Send notice via notification methods                                                                                                                                                                                | Mail                 |
| New registration        | Send notice via notification methods. If returned as undeliverable, do not register. If not returned as undeliverable, register.                                                                                    | Mail                 |
| Inactive registration   | Send elector voter confirmation card at least 60 days before election via notification methods. If not returned or not marked undeliverable, and voter has not voted in two general elections, cancel registration. | Mail                 |
| Address change          | None                                                                                                                                                                                                                | N/A                  |
...
| Crime                                   | Colorado Department of Corrections, Colorado U.S. Attorney's office      | Voter currently incarcerated or on parole | Cancel registration - convicted felon                       |
